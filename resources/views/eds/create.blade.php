...
@section('breadcrumb')
    ...
    <span class="mx-2">/</span>
    <span class="font-medium text-slate-900">Crear</span>
@endsection
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10">
                    ...
                    <div class="md:col-span-8">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" 
                            ...
                            placeholder="Ej. Estación Centro" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="direccion" id="direccion" value="{{ old('direccion') }}" 
                                class="input-pill !pl-11" placeholder="Calle 123 # 45 - 67">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email_alertas" id="email_alertas" value="{{ old('email_alertas') }}" 
