...
@section('title', 'Roles - Zahara')
@section('page_title', 'Roles y Permisos')

@section('breadcrumb')
    <span>Inicio</span> / <span class="text-slate-900 font-medium">Roles</span>
@endsection

@section('page_actions')
    <a href="{{ route('roles.create') }}" class="btn-primary px-4 py-2.5 text-sm inline-flex items-center justify-center gap-2 shadow-sm w-full md:w-auto transition-transform active:scale-95">
