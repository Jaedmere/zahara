...
@section('title', 'Nuevo Cliente - Zahara')
@section('page_title', 'Registrar Cliente')
@section('page_subtitle', 'Ingresa los datos fiscales y asignaciones operativas.')
    ...
    <div class="max-w-5xl animate-enter">
        ...
        <form action="{{ route('clientes.store') }}" method="POST" class="space-y-8">
                        ...
                        <div class="w-2/3">
                            ...
                            <div class="relative">
                                <input type="text" name="documento" value="{{ old('documento') }}" 
                                    ...
                                    placeholder="800.000.000-1" required autofocus>
                            </div>
                    ...
                    <div class="md:col-span-7">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="razon_social" value="{{ old('razon_social') }}" 
                                ...
                                placeholder="Ej. Transportes del Norte S.A.S" required>
                        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" class="input-pill !pl-11" placeholder="contacto@cliente.com">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="telefono" value="{{ old('telefono') }}" class="input-pill" placeholder="300 123 4567">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1.5">Dirección</label>
                                <input type="text" name="direccion" value="{{ old('direccion') }}" class="input-pill" placeholder="Calle 123...">
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-slate-200/60">
                ...
                <button type="submit" class="btn-primary min-w-[140px]">Guardar Cliente</button>
            </div>
        </form>
    </div>
@endsection