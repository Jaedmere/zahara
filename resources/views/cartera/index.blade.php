...
<div class="flex flex-col gap-6 w-full" 
    ...
    <!-- TOOLBAR (alineada con la de Consolidado por Cuenta) -->
    <div class="flex flex-col md:flex-row justify-between gap-4 w-full">
        ...
        <!-- BOTÓN EXCEL GENERAL (misma línea que el otro módulo) -->
    ...
    <!-- PANEL LATERAL (DRAWER) CON ESTILO DEL PRIMER MÓDULO -->
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 overflow-hidden">
                                        <h2 class="text-lg font-bold leading-6" id="slide-over-title">
                                            ...
                                            <span class="block truncate" x-text="clienteNombre"></span>
                                        </h2>
                                        
                                        <div class="flex flex-wrap items-center gap-4 mt-2">
                                            <p class="text-indigo-200 text-xs">
                                                Selecciona las cuentas que deseas incluir en el abono.
                                            </p>
                                ...
                                <div class="mt-6 flex flex-col sm:flex-row items-center justify-between bg-indigo-700/50 p-4 rounded-xl border border-indigo-500/30 gap-4">
                                    ...
                                    <div class="flex gap-2 w-full sm:w-auto">
                                        <input type="date" 
                                               name="fecha" 
                                               value="{{ date('Y-m-d') }}" 
                                               class="input-pill text-xs py-2 h-9 bg-indigo-800/50 border-indigo-500 text-white placeholder-indigo-300 focus:ring-white/20" 
                                               required>
                                        
                                        <select name="metodo_pago" 
                                                class="input-pill text-xs py-2 h-9 bg-indigo-800/50 border-indigo-500 text-white focus:ring-white/20 appearance-none" 
                                                required>
                            ...
                            <div class="flex-1 overflow-y-auto bg-slate-50 relative flex flex-col">
                                ...
                                <div class="sticky top-0 z-20 bg-white border-b border-slate-200 px-4 py-3 shadow-sm flex-none">
                                    ...
                                    <div x-show="showFilters" 
                                         x-transition 
                                         class="grid grid-cols-1 sm:grid-cols-4 gap-3 mt-3 pt-3 border-t border-slate-100">
                                        <div class="col-span-1">
                                            <label class="text-[10px] font-bold text-slate-400 uppercase">EDS</label>
                                            <select x-model="filters.eds" 
                                ...
                                <div class="p-4 pb-20">
                                                    ...
                                                    <template x-for="(item, index) in cartera" :key="item.id">
                                                        <tr class="hover:bg-indigo-50/30 transition-colors group cursor-pointer"
                                                            ...
                                                            <td class="px-4 py-3">
                                                                ...
                                                                <div class="text-[9px] text-slate-400 uppercase" 
                                                                     x-text="item.eds.nombre">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="px-4 py-3 text-right font-black text-slate-800 bg-slate-50/50 border-l border-slate-100" 
                                    ...
                                    <div class="mt-4 text-center" x-show="meta.current_page < meta.last_page">
                                        <button type="button" 
                                                @click="loadMore()" 
                                                class="btn-secondary text-xs w-full py-3 border-dashed text-slate-500 hover:text-indigo-600 hover:border-indigo-300">
